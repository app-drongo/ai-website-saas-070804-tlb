...
export default function Cta() {
  const stats = [
    { value: "2M+", label: "Data Points Processed", icon: Database },
    { value: "99.9%", label: "Platform Uptime", icon: Clock },
    { value: "500+", label: "Enterprise Clients", icon: Users },
    { value: "10x", label: "Faster Insights", icon: TrendingUp }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join industry leaders who trust DataFlow Analytics for real-time business intelligence. 
                Start your analytics transformation with our comprehensive platform.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Real-time analytics with automated reporting
              </p>
            </div>
          </div>
        </div>
